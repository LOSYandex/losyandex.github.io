<?
    ...
    Версия 3.0 (ЧЯЛ - Чисто Яндексовый ЛОСЯндекс, или же ЛОСЯндекс v3/ЧЯЛ v3) - ноябрь 2021
	...
	*/
        ...
        /* 
        Допустим, без этой хуйни ЛОСЯндекс - хуйня. Так всё и есть) 
        А если честно - то это файл с локализируемыми и изменяемыми строчками, из под которых всё это и работает 
        */
include "./app/km/losyandex/include/Core.php5";
include "./app/km/losyandex/include/MainStrings.php5";
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
<!-- спизжено с вейбека, просьба не кидать в меня тапочками -->
<!-- привет моментову -->

<!-- Эта часть с историей версий теперь запечатана нахрен, она в коде. Позже перенесу в свой блог :) -->

<!-- Арсений из нашей команды (варений), если что то не так, иди верстай свои веб 1.0 сайты в блокноте, дримвивер и т.п и вёрстка не для тебя)) (На данный момент актуально) -->

<title><? echo $nameinstance; ?></title>
    <link rel="shortcut icon" href="<? echo $icon; ?>">
	<? include_once "./app/km/losyandex/include/Meta.php5"; ?>
    ...
    <table id="head">
        <tbody>
            <tr>
                <td class="g"><i></i></td>
                <td class="h"><a id="sethome" href="about:blank">скоро...</a></td>
                <td><a href="about:blank">скоро...&nbsp;&nbsp;</a>&nbsp;&nbsp;<a class="b-top__link" href="about:blank">скоро...</a></td>
                <td class="m"><a class="b-top__login" href="https://web.archive.org/web/20110815184915/http://mail.yandex.ru/">скоро...</a></td>
                <td class="g"><i></i></td>
            </tr>
        </tbody>
    </table>
            ...
            <tbody>
                <tr>
                    <td class="l-head-left">
                        <h1><img src="app/km/losyandex/include/main/img/logo.png" width="270" height="72" title="" alt="Яндекс"></h1>
                    </td>
        ...
        <table>
            <tbody>
                <tr>
                    ...
                    <td width="25%" class="d"><p>Дизайн&nbsp;- <a href="http://vkontakte.ru/zvukoffffffer">KM:Design </a></p></td>
                    <td width="47%" class="c"><p><a href="about:blank">Тут скоро будет новая фича</a>!
                </p>
        <p><a class="mob" href="m.php">Мобильная версия</a></p></td>
...
<p>&nbsp;</p>
<p>Вёрстка оригинальной русской версии Яндекса </p>
<p>была взята и изменена из интернет-архива Wayback Machine.</p>
<p>&nbsp;</p>
<p>Оригинальные материалы принадлежат компании Yandex LLC.</p></td>
                    <td width="2%" class="g"><i></i></td>
                </tr>
            </tbody>
        </table>
    ...
    <script type="text/javascript">
        $('.kbd').click(function() {
            ...
            window.scrollTo(tabsOffset.left, tabsOffset.top);
        });
    </script>
        </div>
    </div>
